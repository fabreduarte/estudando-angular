...
import { CarroComponent } from './atividade/carro/carro.component';
import { TestObservablesComponent } from './observables/test-observables/test-observables.component';
const routes: Routes = [
    {
        path: '',
